...
modelos <- read.csv("digitosletras.modelo", sep=" ", header=FALSE, stringsAsFactors=F)
...
nombres <- c(0:9, "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L")
rownames(contadores) <- nombres
colnames(contadores) <- c(nombres, NA)
